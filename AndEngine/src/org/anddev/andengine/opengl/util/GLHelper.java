...
public class GLHelper {
	...
	public static int GlMaxTextureWidth = 0;
	...
	public static void reset(final GL10 pGL) {
		int[] b = new int[1];
		pGL.glGetIntegerv(GL10.GL_MAX_TEXTURE_SIZE, b, 0);
		GlMaxTextureWidth = b[0];
	...
	public static boolean isEnableDepthTest() {
		return sEnableDepthTest;
	}

	public static void setDepthTest(GL10 pGL,boolean depthTest) {
